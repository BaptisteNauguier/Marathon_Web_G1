...
### Maintenant, on va essayer de voir comment obtenir les infos sur les tampons afin d'avoir plus d'informations sur ce qu'il y a autour de chaque accident
...
# Affichage du dataframe trié en fonction des valeurs qui ont un x_carre >= 100
chisq_df_sorted |>
  filter(x_carre >= 100)
```
