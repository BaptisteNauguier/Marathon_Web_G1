...
### Analyse des variables de la table Accidents_velo_epci_sf
...
### Analyse des variables de la table lieux_epci
...
#### Initialisation de la table tags
...
#### Sélection de variables (de tags)
...
Voici la source de toutes les descriptions des différents tags: [OpenStreetMap Taginfo](https://taginfo.openstreetmap.org/)
...
### Les zones accidentogènes à Montpellier
...
#### Initialisation de la table avec les informations d'OpenStreetMap
